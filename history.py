...
def save_history_record(notification_type, filename, total, success, failed, responses, is_scheduled=False, scheduled_time=None, schedule_id=None, operator_name=None):
    """保存推播歷史記錄"""
    ensure_data_directory()
