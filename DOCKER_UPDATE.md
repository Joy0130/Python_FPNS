...
- **Volume 掛載**: `-v /var/lib/fpns:/app/data`
...
1. **推播管理測試機** - http://tk8s-ubuntu-master.futsu.com.tw:5002
2. **歷史記錄** - http://tk8s-ubuntu-master.futsu.com.tw:5002/history
3. 發送推播後重新整理結果頁面不會重複提交

## 💾 資料備份

歷史記錄檔案位置：`/var/lib/fpns/history.json`

備份命令：

```bash
sudo cp /var/lib/fpns/history.json /path/to/backup/
```
